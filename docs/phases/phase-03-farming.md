...
- Workers or automation *(phase-04)*
- Inventory storage or capacity — harvested items go to a simple counter *(phase-05)*
- Coins, selling, or the shop *(phase-06)*
- Buildings *(phase-06)*
- Save/load *(phase-07)*
- Seasons or weather affecting growth *(v0.2)*
- Crop quality tiers, fertilizer, or crop diseases *(not planned for v0.1)*
